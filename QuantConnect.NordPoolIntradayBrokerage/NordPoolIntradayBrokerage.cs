...
{
    [BrokerageFactory(typeof(NordPoolIntradayBrokerageFactory))]
    public class NordPoolIntradayBrokerage : Brokerage, IDataQueueHandler, IDataQueueUniverseProvider
    {
        ...
        public NordPoolIntradayBrokerage()
        ...
        public NordPoolIntradayBrokerage(IDataAggregator aggregator) : base("NordPoolIntradayBrokerage")
        {
