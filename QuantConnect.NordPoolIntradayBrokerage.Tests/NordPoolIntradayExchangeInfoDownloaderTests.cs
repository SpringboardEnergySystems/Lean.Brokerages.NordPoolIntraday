...
namespace QuantConnect.Brokerages.NordPoolIntraday.Tests
{
    [TestFixture, Ignore("This test requires a configured NordPoolIntradayExchangeInfoDownloader")]
    public class NordPoolIntradayExchangeInfoDownloaderTests
    {
        [Test]
        public void GetsExchangeInfo()
        {
            var eid = Composer.Instance.GetExportedValueByTypeName<IExchangeInfoDownloader>("NordPoolIntradayExchangeInfoDownloader");
